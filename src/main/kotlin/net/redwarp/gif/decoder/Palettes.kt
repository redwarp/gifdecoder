...
object Palettes {
    ...
    fun createFakeColorMap(size: Int): GifParser.ColorTable {
        return if (size == 2) {
            GifParser.ColorTable(2, intArrayOf(0xff000000.toInt(), 0xffffffff.toInt()))
        } else {
            ...
            GifParser.ColorTable(size, colors)
        }
    }
}
